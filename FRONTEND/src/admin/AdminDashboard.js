...
const NAV = [
  ...
  { key:"addadmin", label:"Add Admin",       icon:"➕" },
  { key:"analytics",label:"Analytics",       icon:"📊" },
  { key:"claims",   label:"Manage Claims",   icon:"📋" },
];
...
export default function AdminDashboard() {
  ...
  const page = { profile:<AdminProfile/>, addadmin:<AddAdmin/>, analytics:<Analytics onNavigate={setActive}/>, claims:<ManageClaims/> };
  ...
  return (
    <div className="dashboard">
      <nav className="care-nav">
        ...
        <span className="nav-role-badge">Administrator</span>
